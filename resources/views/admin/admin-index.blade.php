                ...
                <tr class="border-b dark:border-neutral-500">
                    ...
                    <td>
                        <form method="POST" action="{{ route('admin.update', $usuario->id) }}">
                            ...
                            <select name="role" id="role-{{ $usuario->id }}" class="border border-gray-300 rounded p-2" onchange="this.form.submit()">
                    ...
                    <td class="flex flex-row w-max items-center whitespace-nowrap px-6 py-4">
                        ...
                        <form class="mx-2" action="{{ route('admin.delete', $usuario->id) }}" method="POST">
                            ...
                            <button class="mx-2 bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full block focus:shadow-outline" type="submit">Deletar</button>
                        </form>
                    </td>
                </tr>
            @endforeach
